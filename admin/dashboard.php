    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                ...
                <p class="text-muted">Keep the library organized with quick access to books, students, and issue records.</p>
            </div>
        </div>
        ...
        <div class="row welcome-panel">
            <div class="col-md-8">
                ...
                <p class="text-muted">Use the quick overview below to manage circulation, add new titles, and monitor the collection efficiently.</p>
            </div>
...
?>
  ...
  <a href="reg-students.php">
               <div class="col-md-3 col-sm-3 col-xs-6">
                      <div class="dashboard-card alert alert-danger back-widget-set text-center">
...
<div class="dashboard-card alert alert-info back-widget-set text-center">
